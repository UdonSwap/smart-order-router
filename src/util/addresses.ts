import { CHAIN_TO_ADDRESSES_MAP, ChainId, Token } from 'udonswap-core';
// import { FACTORY_ADDRESS } from 'udonswap-v3';
...
// export const TICK_LENS_ADDRESS = CHAIN_TO_ADDRESSES_MAP[ChainId.MODE].tickLensAddress;
// export const NONFUNGIBLE_POSITION_MANAGER_ADDRESS = CHAIN_TO_ADDRESSES_MAP[ChainId.MODE].nonfungiblePositionManagerAddress;
// export const V3_MIGRATOR_ADDRESS = CHAIN_TO_ADDRESSES_MAP[ChainId.MODE].v3MigratorAddress;
